...
export function HomeClient() {
  ...
  return (
    <div className="flex-grow w-full max-w-container-max mx-auto px-margin-mobile md:px-6 lg:px-gutter pt-stack-lg pb-4 md:pb-stack-lg flex flex-col md:flex-row gap-gutter relative">
      ...
      <main className="w-full md:w-3/4 flex flex-col gap-stack-lg pr-0 md:pr-6 lg:pr-12">
        ...
        <div className="my-1 sm:my-2 flex justify-center">
          <Link
            href="/berita"
            className="group inline-flex items-center gap-1.5 sm:gap-2 text-primary hover:text-primary-dark font-bold text-xs sm:text-base tracking-wide transition-colors cursor-pointer py-1.5 sm:py-2"
          >
