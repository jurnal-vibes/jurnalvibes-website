...
export const DUMMY_ARTICLES: Article[] = [
  // --- ARTICLE 1: Festival Kuliner (EVENT LOKAL) ---
  {
    ...
    tags: ['FestivalKuliner', 'Sukabumi', 'GenZ', 'KulinerLokal', 'UMKM'],
    readTime: '5 min read',
    isHero: true,
    badge: 'VIRAL',
  ...
  // --- ARTICLE 2: Kedai Kopi Cikole (KULINER / LIFESTYLE) ---
  {
    ...
    author: 'Naufal Rizki',
    reporter: 'Naufal Rizki',
    redaktur: 'Ujang Herlan',
    tags: ['KedaiKopi', 'Cikole', 'KulinerSukabumi', 'TempatNongkrong'],
    readTime: '5 min read',
    isHero: true,
    isEditorsPick: true,
    badge: 'HOT',
  ...
  // --- ARTICLE 3: Gunung Gede (WISATA / LIFESTYLE) ---
  {
    ...
    author: 'Dedi Kusnadi',
    reporter: 'Dedi Kusnadi',
    redaktur: 'Ahmad Fauzi',
    tags: ['GunungGede', 'Selabintana', 'WisataAlam', 'PendakianSukabumi'],
    readTime: '6 min read',
    isHero: true,
    isEditorsPick: true,
    badge: 'LATEST',
  ...
  // --- ARTICLE 4: Sukabumi Creative Fest (EVENT LOKAL / MUSIK) ---
  {
    ...
    reporter: 'Ilham Nugraha',
    redaktur: 'Ujang Herlan',
    tags: ['KonserMusik', 'SukabumiCreativeFest', 'IndieMusic', 'EventSukabumi'],
    readTime: '4 min read',
    badge: 'EVENT',
